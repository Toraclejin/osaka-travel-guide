...
⚠ **덴덴타운 상권은 대체로 11:00~19:00.** 8/25 저녁을 신세카이로 내리는 이유이기도 하다.
...
### 남은 것 — 출발 전 확인만 (2026-08-10 기준)

| | 항목 | 상태 |
|---|---|---|
| 🔴 | **팬스타 셔틀 시각** | **승선권이 있어야 확인 가능.** 복귀일(8/26) 막차가 일정을 지배한다 — 공지 기준 코스모스퀘어 13:50 이 막차라 난바 12:50 출발로 잡아뒀다 |
| 🟡 | 도요토미 석벽관 · e스타디움 영업시간 | 둘 다 신규 시설이라 공식에 명시가 없다 |
| 🟡 | 덴덴타운 개별 상점 정기휴무 | 상권 시간(11:00~)만 확인됨. 개별 확인은 못 했고 **추측으로 쓰지 않았다** (R-D10) |
