...
<header class="mast">
  ...
  <div class="pills"><span class="pill">2박 3일</span><span class="pill">총 <b>${total}곳</b></span><span class="pill">교토 <b>제외</b></span><span class="pill">숙소 <b>${
    D.base_hotel && D.base_hotel.name ? esc(D.base_hotel.name) : '미정'}</b></span></div>
</header>
